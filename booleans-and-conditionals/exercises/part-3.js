...
if (fuelLevel < 1000 || engineTemperature > 3500 || engineIndicatorLight === "red blinking"){
    ...
    console.log("Check fuel level. Engine's running hot.");
} else if (fuelLevel > 20000 && engineTemperature <= 2500){
    console.log("Full tank. Engine's good.");
...
//learned that I tend to forget leading parentheses and spend a lot of time debugging due to syntax errors that I gloss over easily. Noted to be more careful of using opening and closing parentheses, brackets, etc.
...
/*let commandOverride = true; //shuttle will launch no matter what*/
